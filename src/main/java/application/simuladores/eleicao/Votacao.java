package application.simuladores.eleicao;
...
public class Votacao {
    ...
    public static void eleicao() {
        ...
        if (votosTotais.size() != 0) {
            ...
            double porcentagem1    = (votosLeanderson   / (double) totalVotos) * 100;
            double porcentagem2    = (votosMario        / (double) totalVotos) * 100;
