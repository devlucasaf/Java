package application.system.animal.petshop.service;
...
import application.system.animal.petshop.model.servico.Agendamento;
...
public class Petshop {
    ...
    public void criarAgendamento(ClientePetshop cliente, Animal animal, Servico servico,
        ...
        Agendamento agendamento = new Agendamento(cliente, animal, servico, dataHora);
        if (vet != null) {
            agendamento.setVeterinarioResponsavel(vet);
        }
