...
public class Funcionario extends Pessoa {
    ...
    public Funcionario(String nome, String cpf, LocalDate dataNascimento, String telefone, String email,
    ...
    public void promover(String novoCargo, double aumentoPercentual) {
        ...
        System.out.println("Funcionário " + nome + " promovido para " + cargo + ". Novo salário: R$" + salario);
    }
