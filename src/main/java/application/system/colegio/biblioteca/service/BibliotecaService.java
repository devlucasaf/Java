package application.system.colegio.biblioteca.service;

import application.system.colegio.biblioteca.enums.StatusEmprestimo;
...
public class BibliotecaService {
    ...
    public BibliotecaService(String nome, String cnpj, String endereco) {
        this.nome = nome;
        this.cnpj = cnpj;
