...
import math.calculadora.completa.model.conversoes.ConversorEnergia;

import javax.swing.*;
import javax.swing.border.EmptyBorder;
import java.awt.*;

public class CalculadoraEnergiaPainel extends JPanel {

    private static final String[] UNIDADES = {"Joule", "Caloria", "kWh", "BTU", "eV"};

    public CalculadoraEnergiaPainel() {
        ...
        cbPara.setSelectedItem("Caloria");
        ...
        btnConverter.addActionListener(e -> {
            try {
                ...
                double resultado = ConversorEnergia.converter(valor, de, para);
