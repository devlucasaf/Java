...
import math.calculadora.completa.model.conversoes.ConversorAngulo;

import javax.swing.*;
import javax.swing.border.EmptyBorder;
import java.awt.*;

public class CalculadoraAnguloPainel extends JPanel {
    public CalculadoraAnguloPainel() {
        ...
        btnConverter.addActionListener(e -> {
            try {
                ...
                double resultado = ConversorAngulo.converter(valor, de, para);
