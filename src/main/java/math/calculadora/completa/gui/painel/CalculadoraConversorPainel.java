...
public class CalculadoraConversorPainel extends JPanel {
    public CalculadoraConversorPainel(String titulo, String[] unidades, double[] fatores) {
        ...
        btnConverter.addActionListener(e -> {
            try {
                ...
                double resultado = ConversorUnidades.converter(valor, fatores[idxDe], fatores[idxPara]);
