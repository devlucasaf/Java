...
public class SistemaLinear3x3 {
    ...
    public static ResultadoSolucao resolver(double[][] coeficientes, double[] constantes) {
        double a1 = coeficientes[0][0];
        double b1 = coeficientes[0][1];
        double c1 = coeficientes[0][2];
        double a2 = coeficientes[1][0];
        double b2 = coeficientes[1][1];
        double c2 = coeficientes[1][2];
        double a3 = coeficientes[2][0];
        double b3 = coeficientes[2][1];
        double c3 = coeficientes[2][2];
        double d1 = constantes[0];
        double d2 = constantes[1];
        double d3 = constantes[2];
