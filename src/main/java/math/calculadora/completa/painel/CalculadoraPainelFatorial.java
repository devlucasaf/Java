...
public class CalculadoraPainelFatorial extends JPanel {

    public CalculadoraPainelFatorial() {
        ...
        btnCalcular.addActionListener(e -> {
            try {
                ...
                if (n < 0) {
                    lblResultado.setText("Resultado: n deve ser ≥ 0");
                    return;
                }
                ...
                lblResultado.setText("Resultado: " + fat.toString());
