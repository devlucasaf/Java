...
public class CalculadoraPainelConversor extends JPanel {

    public CalculadoraPainelConversor(String titulo, String[] unidades, double[] fatoresBase) {
        ...
        JLabel lblResultadoConv = new JLabel("Resultado: ");
        lblResultadoConv.setForeground(TemaEscuro.TEXTO);
        gridBagConstraints.gridx = 0; gridBagConstraints.gridy = 4;
        gridBagConstraints.gridwidth = 2;
        add(lblResultadoConv, gridBagConstraints);
        ...
        btnConverter.addActionListener(e -> {
            try {
                ...
                double fatorDe = fatoresBase[idxDe];
                double fatorPara = fatoresBase[idxPara];
                double resultado = valor * (fatorPara / fatorDe);
                lblResultadoConv.setText(String.format("Resultado: %.6f", resultado));
            } catch (Exception ex) {
                lblResultadoConv.setText("Erro no valor!");
            }
        });
    }
}