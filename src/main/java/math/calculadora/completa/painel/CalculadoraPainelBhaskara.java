...
public class CalculadoraPainelBhaskara extends JPanel {

    public CalculadoraPainelBhaskara() {
        ...
        btnCalcular.addActionListener(e -> {
            try {
                ...
                if (a == 0) {
                    lblResultado.setText("Resultado: a não pode ser zero.");
                    return;
                }
                ...
                if (delta < 0) {
                    ...
                    double x = -b / (2 * a);
                    lblResultado.setText(String.format("Resultado: x = %.4f (raiz dupla)", x));
                } else {
                    double x1 = (-b + Math.sqrt(delta)) / (2 * a);
                    double x2 = (-b - Math.sqrt(delta)) / (2 * a);
                    lblResultado.setText(String.format("Resultado: x1 = %.4f, x2 = %.4f", x1, x2));
                }
